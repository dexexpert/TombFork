...
contract MeerkatToken is BEP20("Mad Meerkat Finance", "MMF") {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "MMF::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "MMF::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "MMF::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "MMF::_writeCheckpoint: block number exceeds 32 bits"
        );
